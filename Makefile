...
FABCUST := fabric-custom/intro.md fabric-custom/background.md fabric-custom/exp-define.md fabric-custom/simulation.md fabric-custom/testbed.md
start_fabric.ipynb: $(FABSNIP) $(FABCUST)
	pandoc --resource-path=../ --embed-resources --standalone --wrap=none \
                ...
                fabric-custom/simulation.md fabric-custom/testbed.md \
